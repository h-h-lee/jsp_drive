...
<form id="deleteForm" method="post" action="memberDelete.do">
  ...
  <br>
  			<div class="form-group" id="divEmail">
				...
				<div class="col-lg-7">
					<input type="text" class="form-control" id="id" name="id" maxlength="8" readonly="readonly" value="${admin_num2}">
				</div>
			</div>	
			<br>
...
<!-- 					<span id="message_pw"></span> -->
  ...
  <button type="submit" class="btn btn-danger">일반관리자 삭제</button>
